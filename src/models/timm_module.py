...
class TimmLitModule(LightningModule):
    ...
    def __init__(
        ...
        self.train_auc = MultilabelAUROC(num_labels=5, average="macro", thresholds=5)
        self.val_auc = MultilabelAUROC(num_labels=5, average="macro", thresholds=5)
        self.test_auc = MultilabelAUROC(num_labels=5, average="macro", thresholds=5)
    ...
    def step(self, batch: Any):
        x, y = batch
        # y = torch.tensor(y, dtype=torch.long) # RuntimeError: expected scalar type Long but found ***
